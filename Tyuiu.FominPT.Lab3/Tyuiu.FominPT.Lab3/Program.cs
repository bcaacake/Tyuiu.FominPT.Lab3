...
namespace Tyuiu.FominPT.Lab3
{
    class Program
    {
        public static int indexItem;

        static void UpArrow() //Нажатие стрелки вверх
        {
            indexItem--;
            if (indexItem < 1)
            {
        ...
        static void DownArrow() //Нажатие стрелки вниз
        {
            indexItem++;
            if (indexItem > 5)
            {
        ...
        static void selectItem() //Выбор пункта в главном меню
        {
            switch (indexItem)
            {
                case 1:
        ...
        static void Option1() //Выполняется при выборе пункта 1 в главном меню
        {
            ...
            Console.WriteLine($"Ответ: Z = {fe.CalculateFirstExpression(x, y, a)}");
        ...
        static void Option2() //Выполняется при выборе пункта 2 в главном меню
        {
            ...
            Console.WriteLine("Введите значение A:");
            a = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"Ответ: Z = {se.CalculateSecondExpression(x, y, a)}");
        ...
        static void Option3() //Выполняется при выборе пункта 3 в главном меню
        {
            ...
            int len = tmf.CalculateTabMathFunction(startValue, stopValue).Length;
            double[] valueArray = new double[len];
            valueArray = tmf.CalculateTabMathFunction(startValue, stopValue);
        ...
        static void OptionFS() //Выполняется при выборе cправки в главном меню
        {
            Console.Clear();
            ...
            Console.WriteLine(" Программу разработал ФОМИН ПЁТР ТАРАСОВИЧ | МКМб-22-1 | ТИУ 2024");
            Console.SetCursorPosition(0, 22);
            Console.WriteLine("------------------------------------------------------------------------------");
        ...
        static void drawMainMenu()
        {
            ...
            Console.WriteLine("║                        Выполнил Фомин Пётр Тарасович                      ║");
